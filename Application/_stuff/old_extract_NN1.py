...
if __name__ == "__main__":
    ...
    #ultimate_knowledge['Activation functions'] = [('fc1', 'ReLU'), ('fc2', 'ReLU'), ('fc3', 'ReLU'), ('fc4', 'ReLU'), ('fc5', 'ReLU'), ('fc6', 'ReLU')]; # 
    ultimate_knowledge['Activation functions'] = [('fc1', 'ReLU'), ('fc2', 'ReLU'), ('fc3', 'ReLU'), ('fc4', 'ReLU')]; # 
