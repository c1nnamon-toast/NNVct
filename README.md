...
Focuces layout for the chosen layer with 2 adjucent layers from both sides
![Focuces layout for the chosen layer and 2 layers to the left and right](image-1.png)
